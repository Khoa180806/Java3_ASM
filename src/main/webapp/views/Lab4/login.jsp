...
<head>
    ...
    <style>
        ...
        button { width: 100%; padding: 10px 14px; border-radius: 6px; border: 1px solid #3b82f6; background: #3b82f6; color: #fff; cursor: pointer; }
        button:hover { filter: brightness(1.05); }
        .msg { max-width: 360px; margin: 8px auto; color: #b91c1c; }
    </style>
</head>
<body>
